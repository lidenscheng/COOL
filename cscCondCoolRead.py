...
#  readPars = ["ped", "noise", "f001", "status"]
  readPars = ["f001"]
...
if('f001Override' not in dir()):
  f001Override = "CscFthold-RUN2-BLK-UPD1-006-00"
if('noiseOverride' not in dir()):
  noiseOverride = "CscNoise-RUN2-BLK-UPD1-006-00"
if('pedOverride' not in dir()):
  pedOverride = "CscPed-RUN2-BLK-UPD1-006-00"
if('statusOverride' not in dir()):
  statusOverride = "CscStat-RUN2-BLK-UPD1-007-00"
if('rmsOverride' not in dir()):
  rmsOverride = "CscRms-RUN2-BLK-UPD1-003-00"
if('t0baseOverride' not in dir()):
  t0baseOverride = "CscT0base-RUN2-BLK-UPD1-001-00"
if('t0phaseOverride' not in dir()):
  t0phaseOverride = "CscT0phase-RUN2-BLK-UPD2-001-00"
...
#CscReadWriteCool Str to read a file from database
...
#conddb.setGlobalTag('CONDBR2-BLKPA-2015-09')
